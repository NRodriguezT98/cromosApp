...
export default function HistorialScreen() {
  ...
  const sections: DaySection[] = useMemo(() => {
    ...
    for (const entry of history) {
      const key = new Date(entry.timestamp).toLocaleDateString('es-CO', { timeZone: 'America/Bogota' });
        ...
        <SectionList
          ...
          renderSectionHeader={({ section: { title, data } }) => (
            <View style={styles.dayHeader}>
              ...
              <Text style={[Typography.labelS, { color: Colors.textMuted }]}>
...
const styles = StyleSheet.create({
  ...
  clearBtn: {
    ...
    borderWidth: 1, borderColor: Colors.red + '40', backgroundColor: Colors.red + '10',
  },
