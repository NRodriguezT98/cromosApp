...
export function TradeModal({ visible, onClose }: Props) {
  ...
  const filteredReceive = useMemo(() => {
    const base = showAll ? stickers : missing;
    return query2 ? base.filter(s => matchesQuery(s, query2)) : base;
  }, [missing, stickers, query2, showAll]);
      ...
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          ...
          <View style={{ flex: 1 }}>
            <View style={styles.padH}>
              <Text style={styles.stepHint}>
                Seleccioná los cromos repetidos que le diste a alguien.
              </Text>
            ...
            {filteredDuplicates.length === 0 ? (
              <View style={styles.emptyState}>
                <Text style={styles.emptyText}>
                  {duplicates.length === 0
                    ? 'No tenés cromos repetidos registrados.'
        ...
        {step === 1 && (
          <View style={{ flex: 1 }}>
            <View style={styles.padH}>
              <Text style={styles.stepHint}>
                Seleccioná los cromos que recibiste a cambio.
              </Text>
